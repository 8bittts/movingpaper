...
<p align="center">
  <!-- version-badge -->v0.043<!-- /version-badge --> · macOS 15+ · Apple Silicon · Swift 6 · MIT · <a href="https://x.com/8BIT/status/2043384259482902603">Short Demo</a>
</p>
...
<!-- download-link -->
[**Download MovingPaper v0.043**](https://github.com/8bittts/movingpaper/releases/download/v0.043/MovingPaper-0.043.dmg)
<!-- /download-link -->
...
| Updates | [Sparkle](https://sparkle-project.org) 2.10.0 (EdDSA-signed feed, signed archives, signed-feed enforcement, verify-before-extraction, vendored) |
